...
########- This script is based onto google legal searches about how this works.
        bank = "B"
        bank += pan
        cardholder_fname = input("Enter CardHolder First Name: ")
        cardholder_lname = input("Enter CardHolder Last Name: ")
        ...
        time.sleep(2)
        print(f'\n{bank}^{cardholder_lname.upper()}/{cardholder_fname.upper()}^{card_expiry}{servicecode}{service10}{trackfix}{service6}')
        time.sleep(1)
